                ...
                foreach ($Device in $UserDevicesDetailsRaw) {
                    ...
                    if ($HuduDevice) {                            
                        try {
                            ...
                            $CompanyResult.Errors.add("User $($User.UserPrincipalName): Relationship already exists, or creation failed")
                        }
                    }
                }
                ...
                if ($DeviceCreation -eq $true) {
                    ...
                    if ($HuduUser) {
                        try {
                            ...
                            $CompanyResult.Errors.add("Device $($HuduDevice.name): Relationship already exists or create failed")
                        }
                    }
                }
            }
